...
def home(request):
    ...
    genius = lyricsgenius.Genius('q3Hg0dfLarYZXLJpKIqTTQv1aF86ekG4-')
...
def view_lyrics(request, id):
    ...
    song_id = genius.song(id, text_format='markdown')
    ...
    return render(request,"view_lyrics.html", {'lyrics':lyrics})
